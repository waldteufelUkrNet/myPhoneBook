...
var list = document.getElementById('list'); // ↑↑↑ VARIABLES DECLARATION ↑↑↑

// ↓↓↓ EVENT HANDLERS ↓↓↓
...
document.querySelector('.contact-card__more-info-button-wrapper').addEventListener('click', toggleMoreInfo); // ↑↑↑ EVENT HANDLERS ↑↑↑

...
function ready() {
  ...
  var firstSectionHeight = document.getElementById('section1').offsetHeight;
  var secondSectionHeight = document.getElementById('section2').offsetHeight;
  var listHeight = 'calc( 100vh - ' + firstSectionHeight + 'px - ' + secondSectionHeight + 'px - 10px - 40px - 10px - 5px )';
  document.getElementById('list').style.height = listHeight; // ↑↑↑ визначаємо висоту списку ↑↑↑

  var tempArr = sortDataBaseAlphabetical();
...
function waleSortType(e) {
  ...
  if (!sortType) return; // підсвітка вибору
...
function sortDataBaseAlphabetical() {
  ...
  for (var i = 0; i < phoneBook.length; i++) {
    if (phoneBook[i].group == 'допомога' || phoneBook[i].group == 'установи' || phoneBook[i].group == 'спец.номери') continue;
...
function writeGroupHeaders() {
  keyForCompare = 'group';
  phoneBook.sort(compare); // шукаємо назви груп та сортуємо їх у алфавітному порядку

  var setOfGroupNames = new Set();
...
function buildItemsList(arr, target) {
  for (var i = 0; i < arr.length; i++) {
    ...
    var itemHTML = '<div class="phone-book-item__name-wrapper">\
...
function groupsAccordion(e) {
  ...
  if (e.target.nextSibling.isOpen) {
    ...
    var tempArr = document.getElementsByClassName('phone-book-group-wrapper');
    ...
    var oneGroupArr = formOneGroup(e.target.dataset.groupName);
...
function showContactCard(e) {
  ...
  var contact = e.target.closest('.phone-book-item');
  if (!contact) return;
  contact = contact.getAttribute('data-shortName');
  var obj = phoneBook.find(function (obj) {
    return obj.shortName == contact;
  ...
  for (var i = 0; i < obj.phone.length; i++) {
...
function toggleMoreInfo(e) {
  ...
  var wrapper = document.querySelector('.contact-card__more-info-wrapper');

  if (!isMoreInfoOpen) {
    isMoreInfoOpen = true;
    wrapper.style.height = 'auto';
    var height = wrapper.offsetHeight + 'px';
    wrapper.style.height = '0px';
    wrapper.style.transition = 'height 1s'; // чому не працює без затримки?
